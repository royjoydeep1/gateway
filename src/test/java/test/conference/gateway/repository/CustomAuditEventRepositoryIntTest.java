package test.conference.gateway.repository;

import test.conference.gateway.GatewayApp;
import test.conference.gateway.config.Constants;
import test.conference.gateway.config.audit.AuditEventConverter;
import test.conference.gateway.domain.PersistentAuditEvent;
...
import static test.conference.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
