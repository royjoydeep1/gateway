package test.conference.gateway.web.rest;

import test.conference.gateway.config.Constants;
import test.conference.gateway.GatewayApp;
import test.conference.gateway.domain.Authority;
import test.conference.gateway.domain.User;
import test.conference.gateway.repository.AuthorityRepository;
import test.conference.gateway.repository.UserRepository;
import test.conference.gateway.security.AuthoritiesConstants;
import test.conference.gateway.service.MailService;
import test.conference.gateway.service.dto.UserDTO;
import test.conference.gateway.web.rest.errors.ExceptionTranslator;
import test.conference.gateway.web.rest.vm.KeyAndPasswordVM;
import test.conference.gateway.web.rest.vm.ManagedUserVM;
import test.conference.gateway.service.UserService;
